...
public class MainActivity_xiejing extends AppCompatActivity {
    private int theme = 0;
    private String user="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            theme = UiUtils.getAppTheme(MainActivity_xiejing.this);
        } else {
        ...
        setContentView(R.layout.activity_main_xiejing);
        ...
        if (theme != R.style.Theme_Shiyun) {
            ...
            imageButton2.setImageResource(R.drawable.light_shuqing3);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                UiUtils.switchAppTheme(MainActivity_xiejing.this);
                load();
            }
        });
        ...
        imageButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity_xiejing.this, SetActivity.class);
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity_xiejing.this, PoemGenerateActivity.class);
                startActivity(intent);
            }
        });
        ...
        imageButton4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity_xiejing.this,MapActivity.class);
                startActivity(intent);
            }
        });
        ...
        imageButton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=null;
                if(theme != R.style.Theme_Shiyun) {
                    intent = new Intent(MainActivity_xiejing.this, ListActivity.class);
                }
                else{
                    intent = new Intent(MainActivity_xiejing.this, AnswerActivity.class);
                }
                startActivity(intent);
            }
        });
